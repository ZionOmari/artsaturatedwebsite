...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'grayscale-pulse': 'grayscalePulse 2s ease-in-out infinite',
  ...
  plugins: [
    ...
    // Custom plugin for visual effects
    function({ addUtilities, theme }) {
      const newUtilities = {
        '.visual-effect-none': {
          filter: 'none',
        },
        '.visual-effect-grayscale': {
        ...
        '.visual-effect-contrast': {
          filter: 'contrast(150%)',
        },
        '.visual-effect-bright': {
        ...
        '.filter-blue-tone': {
          filter: 'hue-rotate(240deg) saturate(50%) contrast(110%)',
        },
        '.glassmorphism': {
